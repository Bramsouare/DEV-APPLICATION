<?php
    ...
    $mail -> Body = "Bonjour " . $_SESSION["nomPrenom"] . "<br><br> 
        ...
        "<br><br>et vous livrera à l'adresse: " .$_SESSION["adresses"] . 
    ...
    if ($mail) 
    {
        ...
        {
            echo "L'envoi du mail a échoué.<br><br><strong> l'erreur suivante s'est produite AAAAA:  </strong>", $mail -> ErrorInfo;
        }
    }
